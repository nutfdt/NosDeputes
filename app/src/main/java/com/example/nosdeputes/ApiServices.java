                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Deputy deputy = new Deputy(jsonObjectDeputy.getInt("id"),
                                    ...
                                    jsonObjectDeputy.getString("twitter"),
                                    jsonObjectDeputy.getString("sexe"),
                                    jsonObjectDeputy.getInt("place_en_hemicycle"),
                                    jsonObjectDeputy.getString("url_an"));
                            deputy.setGroupeParlementaire(jsonObjectDeputy.getString("groupe_sigle"));
                            deputy.setEmail(jsonObjectDeputy.getJSONArray("emails").getJSONObject(0).getString("email"));
                            deputy.setAdressePerm(jsonObjectDeputy.getJSONArray("adresses").getJSONObject(0).getString("adresse"));
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                Vote vote = new Vote(
                                        ...
                                        object.getString("position_groupe"),
                                        object.getJSONObject("scrutin").getString("url_institution")
